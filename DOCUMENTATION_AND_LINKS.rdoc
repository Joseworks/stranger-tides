Factory girl cannot be used passing arguments!


time rake stations_delete:delete_station_list
time rake station_list:process_station_list
time rake station_list:process_all_stations




heroku rake stations_delete:delete_station_list
...
Add to the list to use json to store hashes in postgres :)! (JSON)
